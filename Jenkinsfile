 ...
 */
  ...
  stage('UploadArtifactsIntoNexus'){
    steps{
       ...
       nexusPublisher nexusInstanceId: 'nexus3', nexusRepositoryId: 'sample', packages: [[$class: 'MavenPackage', mavenAssetList: [[classifier: '', extension: '', filePath: '/home/jenkins/jenkins-workspace/workspace/JavaMavenProj/target/maven-web-application.war']], mavenCoordinate: [artifactId: 'Maven_project', groupId: 'com.jenkins-ci.main', packaging: 'war', version: $BUILD_NUMBER]]]
    }
  }
 /* 
